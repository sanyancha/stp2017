...
<div class="row content">
    ...
    <div class="col-sm-8 col-xs-8">
        <h1>Total number of available to leave courses ${countCourses}<h1>
    </div>
    <div class="col-sm-2 col-xs-2 sidenav">
    </div>
</div>
    ...
    <div class="col-sm-8 col-xs-8">
        <div class="row">
            <div class="col-sm-4 col-xs-4">
                ...
                <br/>
                <div class="input-group">
                    <span class="input-group-addon">Balance after submit</span>
...
<button id="submit-data" type="button" class="btn btn-my center-block"
        onclick="sendData('/delete-course','idCourses')" <#--onclick="getValueActiveCheckBoxes(1)"-->>Submit
</button>
...
<script>
    ...
    for (var i = 0; i < checkboxes.length; i++) {
        ...
        checkbox.onclick = function () {
            ...
            var after = parseFloat(num) + parseFloat(prise);
